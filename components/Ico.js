...
const contractAddress = "0xE810eB39a62a6B3bfa1779afeAD662c31d79bA46";
...
export default function Ico() {
    ...
    async function fetchData() {
        if(typeof window.ethereum !== 'undefined') {
            ...
            try {
                ...
                const balancesToken1 =  await contract.balancesToken1(accounts[0]);
                const balancesToken2 =  await contract.balancesToken2(accounts[0]);
                const balancesToken3 =  await contract.balancesToken3(accounts[0]);
    ...
    async function buyTokensRound1 () {
        if(typeof window.ethereum !== 'undefined') {
            ...
            const transaction = await usdc.approve(contractAddress, usdcApproval, overrides);
    ...
    return (
            <div className="App mx-20 my-10">
                <p className="text-base text-grey">
                    Wallet : {accounts.slice(0,5)+'...'+accounts.slice(38,42)}
                </p>
                <p className="text-base text-grey">
